...
<head>
    ...
    <link rel="stylesheet" href="css/g_style.css?php echo time(); ?>" media="all" type="text/css">
    ...
    <div id="wrapper">
        ...
        <div id="menu">
            <ul>
                ...
                <li>
                    <a href="g_index.php">Home</a>
                </li>
                <li>
                    <a href="g_add.php">Add</a>
                </li>
                <li>
                    <a href="g_update.php">Update</a>
                </li>
                <li>
                    <a href="g_search.php">Search</a>
                </li>
                <li>
