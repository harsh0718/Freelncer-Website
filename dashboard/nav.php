    ...
    <div class="nav-items">
      ...
      <li class="nav-item dropdown fw-bolder">
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown ">
          <li><a class="dropdown-item" href="filter.php?id=1">Graphic Design</a></li>
          <li><a class="dropdown-item" href="filter.php?id=2">Programming And Tech</a></li>
          <li><a class="dropdown-item" href="filter.php?id=3">Digital Marketing</a></li>
          <li><a class="dropdown-item" href="filter.php?id=4">Music & Audio</a></li>
          <li><a class="dropdown-item" href="filter.php?id=5">Bussiness</a></li>
          <li><a class="dropdown-item" href="filter.php?id=6">Other</a></li>
        </ul>
      </li>
